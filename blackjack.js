...
const flipSound = new Audio('static/sounds/card-flip.wav');
const dealSound = new Audio('static/sounds/deal.wav');
const winSound = new Audio('static/sounds/win.wav');
const tieSound = new Audio('static/sounds/tie.wav');
...
function createCard() {
    ...
    card.src = `static/cards/${displayValue}-${cardSuit}.png`
    return card
}
...
function resetGame() {
    ...
    dealerCard1Back.src = 'static/cards/BACK.png';
...
async function dealerDrawUpTo17() {
    await delay(800);
    playSound(flipSound);
    const dealerCard1Back = dealerHand.querySelector('img[src="static/cards/BACK.png"]');
    dealerCard1Back.src = `static/cards/${dealerCard1.displayValue}-${dealerCard1.cardSuit}.png`;
